...
CubemapRenderer.prototype.initialize = function () {
    ...
    // Anything tagged reflective is given an env map.
    const mats = this.app.assets.findByTag('reflective');
    //! Note, changing the material's properties in the editor at runtime
    // will not preserve this change. You will need to re-apply the material/refresh page.
    mats.forEach((mat) => {
        mat.resource.cubeMap = this.cubeMap;
        mat.resource.update();
    });
};
CubemapRenderer.prototype.update = function () {
};
